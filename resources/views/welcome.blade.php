...
<body>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                @auth
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link {{ Request::routeIs('dashboard-warga') ? 'active' : '' }}"
                                aria-current="page" href="{{ route('dashboard-warga') }}">Beranda</a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="pengajuanDropdown">
                                ...
                                <li><a class="dropdown-item" href="{{ route('warga-pindah') }}">Surat Warga Pindahan</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link  {{ Request::routeIs('bansos.*') ? 'active' : '' }}" href="#"
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link  {{ Request::routeIs('pengaduan.*') ? 'active' : '' }}" href="#"
                                id="pengaduanDropdown" role="button" data-bs-toggle="dropdown"
                                aria-expanded="false">Pengaduan Warga</a>
                            <ul class="dropdown-menu" aria-labelledby="pengaduanDropdown">
                                <li><a class="dropdown-item {{ Request::routeIs('pengaduan') ? 'active' : '' }}"
                                        href="{{ route('pengaduan') }}">Ajukan Pengaduan</a></li>
                                <li><a class="dropdown-item {{ Request::routeIs('pengaduan.history') ? 'active' : '' }}"
                                        href="{{ route('pengaduan.history') }}">List Pengaduan</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="bansosDropdown">
                                <li><a class="dropdown-item" href="{{ route('pengajuan-umkm') }}">Macam Macam UMKM</a>
                                </li>
                                <li><a class="dropdown-item" href="{{ route('pengajuan-umkm.create') }}">Pengajuan
                                        UMKM</a></li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="program-baris-ikon">
                <div class="program-ikon dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <li><a class="dropdown-item check-login" href="{{ route('warga-tetap') }}">Surat Warga
                                Tetap</a></li>
                        <li><a class="dropdown-item check-login" href="{{ route('warga-pindah') }}">Surat Warga
                                Pindahan</a></li>
                    </ul>
                </div>
                <div class="program-ikon dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <li><a class="dropdown-item check-login" href="{{ route('pengaduan') }}">Ajukan Pengaduan</a>
                        </li>
                        <li><a class="dropdown-item check-login" href="{{ route('pengaduan.history') }}">List
                                Pengaduan</a></li>
                    </ul>
                </div>
                <div class="program-ikon dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <li><a class="dropdown-item check-login" href="{{ route('pengajuan-umkm') }}">Macam-Macam
                                UMKM</a></li>
                        <li><a class="dropdown-item check-login"
                                href="{{ route('pengajuan-umkm.create') }}">Pengajuan UMKM</a>
                        </li>
                    </ul>
                </div>
                ...
                <a href="{{ route('warga.bansos.create') }}" class="program-ikon check-login"
                    aria-label="Pengajuan Bansos">
                    <img src="{{ asset('assets/icon/bansos.png') }}" alt="Pengajuan Bansos">
                    <div class="program-title">Pengajuan Bansos</div>
                </a>
                <a href="{{ route('warga.bansos.penerima') }}" class="program-ikon check-login"
                    aria-label="Penerima Bansos">
                ...
                <div class="program-ikon dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <li><a class="dropdown-item check-login" href="{{ route('warga.Warga.index') }}">Data
                                Warga</a></li>
                        <li><a class="dropdown-item check-login" href="{{ route('warga.keluarga.index') }}">Data
                ...
                @foreach ($pengumuman as $item)
                    <div class="col-lg-3">
                        <div class="card border-0 shadow-sm"
                            onclick="location.href='{{ route('berita.show', $item->id_pengumuman) }}'">
                            @if ($item->foto)
                                <img src="{{ asset('storage/' . $item->foto) }}" class="card-img-top img-fluid mb-3"
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-secondary">{{ \Illuminate\Support\Str::limit($item->isi, 100, '...') }}
                                </p>
                                <a href="{{ route('berita.show', $item->id_pengumuman) }}"
                                    class="btn btn-primary mt-auto align-self-start">Baca Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                @endforeach
                        ...
                        <div class="col-lg-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><span class="bi bi-alarm"></span> <span
                                            class="icon-text">{{ $item->waktu_mulai }} -
                                            {{ $item->waktu_selesai ? $item->waktu_selesai : 'selesai' }}</span></p>
                                    <p class="card-text"><span class="bi bi-calendar-check"></span> <span
                                            class="icon-text">{{ \Carbon\Carbon::parse($item->tanggal_kegiatan)->translatedFormat('l, d F Y') }}</span>
                                    </p>
                                    <p class="card-text"><span class="bi bi-geo-alt-fill"></span> <span
                                            class="icon-text">{{ $item->lokasi_kegiatan }}</span></p>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="row g-3">
                <div class="col-lg-3 col-md-6 col-6">
                    <a class="image-link" href="{{ asset('assets/img/kerja bakti.jpg') }}">
                        <img src="{{ asset('assets/img/kerja bakti.jpg') }}" class="img-fluid-doc rounded"
                            alt="">
                    </a>
                </div>
                <div class="col-lg-3 col-md-6 col-6">
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <a class="image-link" href="{{ asset('assets/img/maulid nabi.jpg') }}">
                        <img src="{{ asset('assets/img/maulid nabi.jpg') }}" class="img-fluid-doc rounded"
                            alt="">
                    </a>
                </div>
                <div class="col-lg-3 col-md-6 col-6">
                    <a class="image-link"
                        href="{{ asset('assets/img/kegiatan-jalan-santai-yang-digelar-gerakan-pemuda-dan-peremp-g4of.jpg') }}">
                        <img src="{{ asset('assets/img/kegiatan-jalan-santai-yang-digelar-gerakan-pemuda-dan-peremp-g4of.jpg') }}"
                            class="img-fluid-doc rounded" alt="">
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="row fade-up">
                    ...
                    <div class="col-12 col-md-3 mb-4">
                        ...
                        <div class="d-flex">
                            <a href="" target="_blank" class="text-decoration-none text-dark">
                                <img src="{{ asset('assets/icon/ig.ico') }}" height="30" width="30"
                                    class="me-3" alt="Instagram Icon">
                                <a href="https://www.instagram.com/nggadungan?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                                    class="nav-link p-0 text-muted">nggadungan</a>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-3 mb-4">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item mb-2">
                                <a href="https://maps.app.goo.gl/GQnGXpcnKqJPHJsd9?g_st=ico"
                                    class="nav-link p-0 text-muted">
                                    <span class="fas fa-map-marker-alt"></span>
                                    <span class="icon-text">RW. 02 Kelurahan Candirenggo Kecamatan Singosari, Kabupaten
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            @if (session('success'))
                showLoginSuccessAlert("{{ session('success') }}",
                    {{ session('change_password') ? 'true' : 'false' }});
                ...
                didOpen: () => {
                    ...
                    toggleButtons.forEach(button => {
                        button.addEventListener('click', () => {
                            const input = Swal.getPopup().querySelector(button.getAttribute(
                                'data-toggle'));
