    ...
    <div class="container-fluid">
        <div class="card mt-3">
            <div class="card-header d-flex justify-content-between align-items-center"
                ...
                <div>
                    <a href="{{ route('RTverifikasiWargaPindah.index') }}" class="btn btn-sm btn-light me-2">
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($warga->foto_ktp)
                                        <img src="{{ asset('storage/' . $warga->foto_ktp) }}" alt="Foto KTP"
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($warga->foto_surat_pindah)
                                        <img src="{{ asset('storage/' . $warga->foto_surat_pindah) }}"
                                            alt="Foto Surat Pindah" style="max-width: 100px;">
                                    @else
                                        Tidak ada foto
                                    @endif
                                </td>
