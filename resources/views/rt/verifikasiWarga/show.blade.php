...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between" style="border-radius: 15px 15px 0 0; background-color: #03774A;">
        <div>
            <a href="{{ route('RTVerifikasiWarga.index') }}" class="btn btn-sm btn-light me-2">
    ...
    <div class="card-body">
        <div class="row">
            <div class="form-group">
                ...
                <div class="form-group mb-3">
                    <label for="telepon" class="text-muted">No Telefon</label>
                    <input type="text" class="form-control" value="{{ $warga->telepon }}" readonly>
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">
                    <label for="nik">Status Kawin</label>
