...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('announcement.index') }}" class="btn btn-sm btn-secondary" style="background-color: #6c757d; border-color: #6c757d;"><i class="fas fa-arrow-left"></i> Kembali</a>
        @else
        <div class="container mt-4">
            <form method="POST" action="{{ route('announcement.update', $pengumuman->id_pengumuman) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
