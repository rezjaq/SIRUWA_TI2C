    ...
    <div class="container-fluid">
        <div class="card mt-3">
            <div class="card-header d-flex justify-content-between align-items-center"
                ...
                <div>
                    <a href="{{ route('citizen.create') }}" class="btn btn-outline-light">
            ...
            <div class="card-body">
                ...
                <div class="d-flex mb-3">
                    <select id="data-type-selector" class="form-control w-auto">
                        <option value="citizen.list">Warga Hidup</option>
                        <option value="citizen.listDeceased">Warga Meninggal</option>
                    </select>
                </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#data-type-selector').on('change', function() {
                    ...
                    if (selectedValue === 'citizen.listDeceased') {
                        newUrl = "{{ route('citizen.listDeceased') }}";
                    } else {
                        newUrl = "{{ route('citizen.list') }}";
                    }
