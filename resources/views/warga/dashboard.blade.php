        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="bansosDropdown" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            Bansos
                        </a>
    ...
    <section id="program" class="mt-4">
        <div class="program-container fade-up">
            <div class="program-baris-ikon">
                ...
                <a href="{{ route('warga-tetap') }}" class="program-ikon check-login"
                    aria-label="Denah Rumah Warga">
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><span class="bi bi-alarm"></span> <span class="icon-text">06:00
                                        - selesai</span></p>
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><span class="bi bi-alarm"></span> <span class="icon-text">06:30
                                        - selesai</span></p>
                                <p class="card-text"><span class="bi bi-calendar-check"></span> <span
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><span class="bi bi-alarm"></span> <span class="icon-text">09:00
                                        - selesai</span></p>
                                <p class="card-text"><span class="bi bi-calendar-check"></span> <span
                                        class="icon-text">Jumat, 19 Mei 2024</span></p>
                                <p class="card-text"><span class="bi bi-geo-alt-fill"></span> <span
                                        class="icon-text">Pos Posyandu</span></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <a class="image-link" href="{{ asset('assets/img/maulid nabi.jpg') }}">
                        <img src="{{ asset('assets/img/maulid nabi.jpg') }}" class="img-fluid rounded"
                            alt="">
                    </a>
                </div>
                <div class="col-lg-3 col-md-6 col-6">
            ...
            <footer>
                <div class="row fade-up">
                    ...
                    <div class="col-12 col-md-3 mb-4">
                        ...
                        <p class="text-muted">
                            <i class="fas fa-map-marker-alt"></i> RW. 02 Kelurahan Candirenggo Kec. Singosari,
