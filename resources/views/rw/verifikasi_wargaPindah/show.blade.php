            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $warga->status }}" readonly>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        @if($warga->foto_ktp)
                            <div class="text-center">
                                <img src="{{ asset('storage/' . $warga->foto_ktp) }}" alt="Foto KTP" class="img-fluid img-thumbnail" style="max-width: 100%; height: auto;">
                            </div>
                        @else
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if($warga->foto_surat_pindah)
                            <div class="text-center">
                                <img src="{{ asset('storage/' . $warga->foto_surat_pindah) }}" alt="Foto Surat Pindah" class="img-fluid img-thumbnail" style="max-width: 100%; height: auto;">
                            </div>
                        @else
